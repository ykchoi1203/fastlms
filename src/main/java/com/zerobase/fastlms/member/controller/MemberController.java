...
public class MemberController {
    ...
    public String log(HttpServletRequest request, Principal principal) {
        String ip =  WebUtils.getClientIp(request);
        String agent = WebUtils.getUserAgent(request);
        String userId = principal.getName();
        MemberDto memberDto = memberService.detail(userId);
        Member member = Member.builder().userId(memberDto.getUserId()).build();

        loginLogService.add(member, ip, agent);

        if(memberDto.isAdminYn()) {
